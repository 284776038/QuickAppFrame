package cn.richinfo.frame.util.http;
...
public class PersistentCookieStore implements CookieStore {
    ...
    protected String encodeCookie(SerializableHttpCookie cookie) {
        ...
        try {
            ...
            LogUtils.d(LOG_TAG, "IOException in encodeCookie" + e.toString());
            return null;
        }
    ...
    protected HttpCookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            LogUtils.d(LOG_TAG, "IOException in decodeCookie" + e.toString());
        } catch (ClassNotFoundException e) {
            LogUtils.d(LOG_TAG, "ClassNotFoundException in decodeCookie" + e.toString());
        }
