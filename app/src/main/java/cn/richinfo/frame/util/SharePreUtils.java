...
public class SharePreUtils {
    ...
    private final static String DEFAULT_FILE = "Roodo";
    private static final SharePreUtils ourInstance = new SharePreUtils();
    ...
    private SharePreUtils() {
        sp = RichApplication.getContext().getSharedPreferences(DEFAULT_FILE, Context.MODE_PRIVATE);
        editor = sp.edit();
        editor.apply();
    }
